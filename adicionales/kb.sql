...
INSERT INTO `criteriocalidad` VALUES (1,'la base debe estar lisa',0,1,NULL,'sin asignar','aun no es revizada por algun inspector'),(2,'la goma debe ser de alta calidad',0,1,NULL,'sin asignar','aun no es revizada por algun inspector'),(7,'crit 7',1,5,7,'aprobado','prueba 1'),(8,'crit 8',1,5,7,'aprobado','iyj'),(9,'crit 9',1,5,7,'aprobado','gthj'),(10,'crit 10',1,5,7,'aprobado','prueba 1'),(11,'cri 200',0,6,17,'sin asignar','aun no es revizada por algun inspector'),(12,'crit 201',0,6,17,'sin asignar','aun no es revizada por algun inspector'),(13,'crit 300',0,4,15,'sin asignar','aun no es revizada por algun inspector'),(14,'crit 301',0,4,15,'sin asignar','aun no es revizada por algun inspector'),(15,'crit 302',0,4,15,'sin asignar','aun no es revizada por algun inspector'),(16,'cc 30',1,7,16,'aprobado','hhhh'),(17,'cc31',1,7,16,'aprobado','llll'),(18,'cc32',1,7,16,'aprobado','hhhh'),(19,'crit 71',1,8,7,'aprobado','iyj'),(20,'',1,8,7,'aprobado','gthj'),(21,'crit 72',1,8,7,'aprobado','iyj'),(22,'crit 73',1,8,7,'aprobado','pppp'),(23,'crit 74',1,8,7,'aprobado','pppp'),(24,'crit 75',1,8,7,'aprobado','kkkkkk'),(25,'crit 76',1,8,7,'aprobado','kkkkkk');
...
INSERT INTO `operarioproduccion` VALUES (1,1,1,'branding de marca'),(2,4,1,'gestion de aleatoriedad'),(3,5,1,'esculpir'),(8,2,4,'rol 1'),(9,5,5,'rol 12'),(10,1,5,'rol 15'),(11,3,6,'rol 100'),(12,4,6,''),(13,4,7,'rol 601'),(14,2,7,'rol 602'),(15,5,8,'rol 90'),(16,1,8,'rol 91'),(17,2,8,'rol 92');
...
INSERT INTO `produccion` VALUES (1,4,3,'2021-02-20','urgente','Pagado'),(4,4,8,'2021-12-07','urgente','en Produccion'),(5,4,1,'2021-12-12','urgente','en Produccion'),(6,3,4,'2021-10-31','Muy urgente','en Produccion'),(7,3,2,'2021-11-10','Muy urgente','en Produccion'),(8,4,9,'2022-01-10','urgente','en Produccion');
...
INSERT INTO `requerimiento` VALUES (1,'cerraduras ultra','de tres cierres electrico','2021-02-19',5000,'390444','emp1','Regular','20% pago adelantado','2021-02-02',100),(2,'tornillos','5 hilos x mil','2021-02-13',4000,'9511ff33','emp2','Buena','5% de defectos se rechaza','2021-02-02',1000),(3,'llaves para moto','llaves con seguro reforzado','2021-04-02',7000,'9974722','motos ronco','Alta','pago contra entrega','2021-02-02',14000),(4,'brazos para freno v-brake','frenos de laton plateado','2021-02-27',8000,'822441','monark del peru','Alta','1% se procede a devolucion','2021-02-02',8000),(5,'carcasa para grupo electrógeno','pintura aislante de calor','2021-04-10',50000,'542233','modasa','Buena','pago por deuda','2021-02-02',1000),(6,'vallas separadoras','debe contener marca de la MML','2021-05-16',70000,'80854','municipalidad de lima','Media','10% adelanto','2021-02-02',1500),(7,'casilleros de metal 6x10','tamaño 40x40','2021-03-17',20000,'902993','maletek','Media','incluyen cerraduras','2021-02-02',20),(8,'lavaderos provisionales','portatiles para poner rotoplas','2021-02-26',500,'876542','cc arenales','Baja','pago por adelantado','2021-02-03',5),(9,'loncheras de aluminio','tamaño 12 x 13 cm','2022-02-16',2500,'66662413','dinamicos del centro','Regular','20% adelanto','2021-11-05',500);
...
-- Dump completed on 2021-11-06 20:18:15
